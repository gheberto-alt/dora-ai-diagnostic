          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2 text-xs">
                <span className="font-semibold uppercase tracking-[0.2em] text-cyan-400">Preview 8 factores</span>
              </div>
              ...
              <form onSubmit={submitAssessment} className="space-y-3 sm:space-y-6">
                <>
                  ...
                  <div className="rounded-2xl border border-slate-800 bg-slate-950 p-3 sm:p-5">
                    <div className="mb-2 text-[11px] font-semibold uppercase tracking-[0.18em] text-cyan-400">Cuestionario corregido de arquetipos</div>
                    ...
                    {question.reverseScore && <p className="mt-2 text-xs text-amber-300">Nota: puntuar alto aquí indica un problema.</p>}
            ...
            <div className="space-y-4 lg:flex lg:h-full lg:min-h-0 lg:flex-col lg:space-y-3">
              ...
              <div className="grid gap-4 lg:min-h-0 lg:flex-1 lg:grid-cols-[1.55fr_0.88fr] lg:gap-4">
                <div className="rounded-2xl border border-slate-800 bg-slate-950 p-4 sm:p-5 lg:flex lg:min-h-0 lg:flex-col lg:p-4 xl:p-4">
                  ...
                  <p className="text-sm text-slate-400">Promedio por factor; en fricción, burnout e inestabilidad, alto significa más riesgo.</p>
